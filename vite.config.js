...
export default defineConfig({
  ...
  ssgOptions: {
    ...
    async includedRoutes(paths, routes) {
      ...
      const httpsAgent = new https.Agent({ rejectUnauthorized: !isProd })
      ...
      // Pobiera WSZYSTKIE strony wyników z danego endpointu WP REST API
      // (WP domyślnie zwraca max 10 na stronę, max 100 na żądanie —
      // ta funkcja iteruje po X-WP-TotalPages, żeby ściągnąć komplet).
      ...
      const finalRoutes = [...staticPaths, ...generatedRoutes];
